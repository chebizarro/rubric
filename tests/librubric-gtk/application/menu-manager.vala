...
namespace Rubric.Tests {
	...
	public class MenuManagerTests : Valadate.Framework.TestCase {
...
""";
	...
	<submenu>
		...
		<attribute name="id">file-section</attribute>
		<section>
			<attribute name="rubric-merge-id">5</attribute>
			<item>
				<attribute name="accel"><Primary>n</attribute>
				<attribute name="label">_New</attribute>
				<attribute name="action">win.file_new</attribute>
...
""";
			...
			testmm.add_menu ("menubar", menubar as GLib.Menu);
	...
	<submenu>
		...
		<attribute name="id">file-section</attribute>
		<section>
			<attribute name="rubric-merge-id">6</attribute>
			<item>
				<attribute name="accel"><Primary>n</attribute>
				<attribute name="label">_New</attribute>
				<attribute name="action">win.file_new</attribute>
...
""";
			...
			testmm.append_menu (menubar as GLib.Menu);
	...
	<submenu>
		...
		<section>
			<attribute name="id">view-section-plugins</attribute>
			<section>
				<attribute name="rubric-merge-id">9</attribute>
				<attribute name="label">Test Section 2</attribute>
			</section>
			<section>
				<attribute name="rubric-merge-id">8</attribute>
				<attribute name="label">Test Section 1</attribute>
			</section>
			<section>
				<attribute name="rubric-merge-id">7</attribute>
...
""";
	...
	<submenu>
		...
		<attribute name="id">file-section</attribute>
		<section>
			<attribute name="rubric-merge-id">10</attribute>
			<item>
				<attribute name="accel"><Primary>n</attribute>
				<attribute name="label">_New</attribute>
				<attribute name="action">win.file_new</attribute>
